...
def main() -> int:
    ...
    print()
    print("  The write-in pad is not drawn here. It is a Word file, built by")
    print("  writein.py rather than by either PDF engine, so neither engine has")
    print("  anything to say about it.")
    print()
